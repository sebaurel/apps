...
ALTER TABLE ONLY public.verification_token DROP CONSTRAINT verification_token_user_id_fkey;
ALTER TABLE ONLY public.utilisateur DROP CONSTRAINT utilisateur_id_photo_fkey;
ALTER TABLE ONLY public.utilisateur_frigo DROP CONSTRAINT utilisateur_frigo_utilisateur_id_fkey;
ALTER TABLE ONLY public.utilisateur_frigo DROP CONSTRAINT utilisateur_frigo_frigo_id_fkey;
ALTER TABLE ONLY public.utilisateur_favoris DROP CONSTRAINT utilisateur_favoris_utilisateur_id_fkey;
ALTER TABLE ONLY public.utilisateur_favoris DROP CONSTRAINT utilisateur_favoris_favoris_id_fkey;
ALTER TABLE ONLY public.recette DROP CONSTRAINT recette_utilisateur_id_fkey;
ALTER TABLE ONLY public.recette DROP CONSTRAINT recette_photo_id_fkey;
ALTER TABLE ONLY public.recette DROP CONSTRAINT "recette_categorie-id-fkey";
ALTER TABLE ONLY public.ingredient DROP CONSTRAINT ingredient_id_unite_fkey;
ALTER TABLE ONLY public.ingredient DROP CONSTRAINT ingredient_id_recette_fkey;
ALTER TABLE ONLY public.ingredient DROP CONSTRAINT ingredient_id_fkey;
ALTER TABLE ONLY public.ingredient DROP CONSTRAINT ingredient_id_aliment_fkey;
ALTER TABLE ONLY public.commentaire DROP CONSTRAINT fk56ql0sk6f2dwf864ca0hsmwlh;
ALTER TABLE ONLY public.etape DROP CONSTRAINT etape_id_recette_fkey;
ALTER TABLE ONLY public.etape DROP CONSTRAINT etape_id_photo_fkey;
ALTER TABLE ONLY public.etape DROP CONSTRAINT etape_id_fkey;
ALTER TABLE ONLY public.commentaire DROP CONSTRAINT commentaire_redacteur_id_fkey;
ALTER TABLE ONLY public.commentaire DROP CONSTRAINT commentaire_id_utilisateur_fkey;
ALTER TABLE ONLY public.commentaire DROP CONSTRAINT commentaire_id_recette_fkey;
ALTER TABLE ONLY public.aliment DROP CONSTRAINT aliment_photo_id_fkey;
ALTER TABLE ONLY public.verification_token DROP CONSTRAINT verification_token_pkey;
...
ALTER TABLE ONLY public.unite DROP CONSTRAINT unite_nom_key;
ALTER TABLE ONLY public.unite DROP CONSTRAINT unite_abreviation_key;
...
ALTER TABLE ONLY public.etape DROP CONSTRAINT etape_pkey;
ALTER TABLE ONLY public.element_collections_recette DROP CONSTRAINT element_collections_recette_pkey;
...
ALTER TABLE ONLY public.aliment DROP CONSTRAINT aliment_nom_key;
...
ALTER TABLE public.element_collections_recette ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.commentaire ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.aliment ALTER COLUMN id DROP DEFAULT;
DROP TABLE public.verification_token;
DROP SEQUENCE public.utilisateur_id_seq;
DROP TABLE public.utilisateur_frigo;
DROP TABLE public.utilisateur_favoris;
...
DROP SEQUENCE public.element_collections_recette_id_seq;
DROP TABLE public.element_collections_recette;
DROP SEQUENCE public.commentaire_id_seq;
DROP TABLE public.commentaire;
DROP TABLE public.categorie;
DROP SEQUENCE public.aliment_id_seq;
